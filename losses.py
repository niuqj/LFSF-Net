...
class CombinedLoss(nn.Module):
    def __init__(self, device):
        ...
        self.alpha1 = 1  # smooth_l1
        self.alpha2 = 0.06 # perc_l
        self.alpha3 = 0.05 # hist_l
        self.alpha4 = 0.5 # ms_ssim
        self.alpha5 = 0.0083 # psnr_l
        self.alpha6 = 0.25 # color_l
    ...
    def forward(self, y_true, y_pred):
        ...
        mse_l = F.mse_loss(y_true, y_pred)  # MSE Loss
